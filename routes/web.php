...
use App\Http\Controllers\ModeloMarcaController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('config-estoque/modelos-marcas', [ModeloMarcaController::class, 'index'])->name('modelos-marcas.index');
    Route::post('config-estoque/modelos-marcas', [ModeloMarcaController::class, 'store'])->name('modelos-marcas.store');
    Route::patch('config-estoque/modelos-marcas/{modeloMarca}', [ModeloMarcaController::class, 'update'])->name('modelos-marcas.update');
    Route::patch('config-estoque/modelos-marcas/{modeloMarca}/status', [ModeloMarcaController::class, 'toggleStatus'])->name('modelos-marcas.toggle-status');
    Route::delete('config-estoque/modelos-marcas/{modeloMarca}', [ModeloMarcaController::class, 'destroy'])->name('modelos-marcas.destroy');
    ...
    Route::get('operacoes-estoque/estoques/{estoque}/materiais', [EstoqueController::class, 'materiais'])->name('estoques.materiais');
